...
#__________________________________________________________________________________________________
## INFLOWS SCENARIOS you actually have three kinds of streamflow inputs. You should take this out of the input data and have a streamflow script where all of this is done. 
